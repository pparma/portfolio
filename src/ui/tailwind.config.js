  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "caption-bold": '"Space Mono", monospace',
        body: '"Space Mono", monospace',
        "body-bold": '"Space Mono", monospace',
        "heading-3": '"Syne", sans-serif',
        "heading-2": '"Syne", sans-serif',
        "heading-1": '"Syne", sans-serif',
        "monospace-body": '"Space Mono", monospace',
        "body-big": '"Space Mono", monospace',
        "headling-4": '"Space Mono", monospace',
      },
      boxShadow: {
