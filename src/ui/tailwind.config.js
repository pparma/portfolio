  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "caption-bold": '"IBM Plex Mono", monospace',
        body: '"IBM Plex Mono", monospace',
        "body-bold": '"IBM Plex Mono", monospace',
        "heading-3": '"Chakra Petch", sans-serif',
        "heading-2": '"Chakra Petch", sans-serif',
        "heading-1": '"Chakra Petch", sans-serif',
        "monospace-body": '"IBM Plex Mono", monospace',
        "body-big": '"IBM Plex Mono", monospace',
        "headling-4": '"IBM Plex Mono", monospace',
      },
      boxShadow: {
